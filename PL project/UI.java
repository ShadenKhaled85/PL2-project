...
public class UI extends JFrame implements ActionListener
{
    ...
    private JButton        mainBtnManageCustomer;
    private JButton        mainBtnCreateAnOffer;
    private JButton        mainBtnShowTotalSales;
    private JButton        mainBtnShowPayment;
    private JButton        mainBtnRegisterAnOffer;
     ...
     */
    public UI(Controller rController)
    {
    ...
    private void createMasterPanelConpornents()
    {
        ...
        mainBtnManageCustomer = new JButton("Manage Customer");
        mainBtnManageCustomer.addActionListener(this);
        mainBtnsPanel.add(mainBtnManageCustomer);


        mainBtnCreateAnOffer = new JButton("Offers & Programs");
        mainBtnCreateAnOffer.addActionListener(this);
        mainBtnsPanel.add(mainBtnCreateAnOffer);

        mainBtnRegisterAnOffer = new JButton("Register in Programs");
        mainBtnRegisterAnOffer.addActionListener(this);
        mainBtnsPanel.add(mainBtnRegisterAnOffer);
        ...
        taMessage.setText("Welcome to the best Restaurant Management System ever !");
        ...
        taMessage.setForeground(Color.decode("#59a1c2"));
    ...
    public void setLoginUserName(String newName)
    {
        currentUserName = newName;
         ...
         {
            labelLoginUserName.setText(newName);
        }
    }
    ...
    public final static byte MODE_USER = 4;
    ...
    public void changeMode(byte state)
    {
        switch(state)
        {
            case MODE_ANONYMOUS:
                ...
                mainBtnRegisterAnOffer.setEnabled(false);
                mainBtnCreateAnOffer.setEnabled(false);
                mainBtnManageCustomer.setEnabled(false);
                break;
            case MODE_EMPLOYEE:
                headBtnLogout.setEnabled(true);
                mainBtnShowMenu.setEnabled(true);
                mainBtnManageCustomer.setEnabled(true);
           ...
           case MODE_MANAGER:
                ...
                mainBtnRegisterAnOffer.setEnabled(false);
                mainBtnCreateAnOffer.setEnabled(true);
                mainBtnManageCustomer.setEnabled(false);
                break;
            case MODE_CUSTOMER:
                headBtnLogout.setEnabled(true);
                ...
                mainBtnShowTotalSales.setEnabled(false);
                mainBtnShowPayment.setEnabled(false);
                mainBtnRegisterAnOffer.setEnabled(true);
                mainBtnCreateAnOffer.setEnabled(false);
                mainBtnManageCustomer.setEnabled(false);
                break;
            case MODE_USER:
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        else if (ae.getSource() == mainBtnCreateAnOffer)
        {
            changeMainPanel("Rewards & Offers and Programs List");
            cEmployeeListPanel.init();
        }
        else if (ae.getSource() == mainBtnRegisterAnOffer)
        {
            changeMainPanel("Rewards & Offers and Programs List");
            cEmployeeListPanel.init();
        }
        else if (ae.getSource() == mainBtnManageCustomer)
        {
            changeMainPanel("Customers List");
            cEmployeeListPanel.init();
        }
    ...
    *****************************************************************/
    private class LoginPanel extends JPanel implements ActionListener
    {
        ...
        private JRadioButton    rbIsManager;
        private JRadioButton    rbIsEmployee;
        private JRadioButton    rbIsCustomer;
        private JRadioButton    rbIsUser;
        ...
        public LoginPanel()
        {
            ...
            rbIsManager = new JRadioButton("Manager");
            gbc.gridx = 0;
            gbc.gridy = 2;
            gbc.gridwidth = 1;
            gbLayout.setConstraints(rbIsManager, gbc);
            rbgroup.add(rbIsManager);
            this.add(rbIsManager);

            rbIsEmployee = new JRadioButton("Employee");
            gbc.gridx = 1;
            gbc.gridy = 2;
            gbc.gridwidth = 1;
            gbLayout.setConstraints(rbIsEmployee, gbc);
            rbgroup.add(rbIsEmployee);
            this.add(rbIsEmployee);

            rbIsCustomer = new JRadioButton("Customer");
            gbc.gridx = 0;
            gbc.gridy = 3;
            gbc.gridwidth = 1;
            gbLayout.setConstraints(rbIsCustomer, gbc);
            rbgroup.add(rbIsCustomer);
            this.add(rbIsCustomer);

            rbIsUser = new JRadioButton("User");
            gbc.gridx = 1;
            gbc.gridy = 3;
            gbc.gridwidth = 1;
            gbLayout.setConstraints(rbIsUser, gbc);
            rbgroup.add(rbIsUser);
            this.add(rbIsUser);
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnLoginOK)
            {
                ...
                char[] password;
                boolean isManager = rbIsManager.isSelected();
                boolean isEmployee = rbIsEmployee.isSelected();
                boolean isCustomer = rbIsCustomer.isSelected();
                boolean isUser = rbIsUser.isSelected();
                byte state = -1;
                ...
                {
                    showConfirmDialog("Message", "Login success!, " +"Welcome " + currentUserName);
                    tfUserID.setText("");
                    pwPassword.setText("");
                    changeMainPanel("Home");
                    setClockOutButton();
    ...
    private void  changeMainPanel(String panelName)
    {
        ...
        displayMessage("Currently at : " + panelName);
    }
    ...
    *****************************************************************/
    private class OrderListPanel extends JPanel implements ActionListener
    {
        ...
        {
            lblTotalSales.setText("Total:EGP " + sales);
        }
        ...
        {
            lblCancelTotal.setText("Cancel total:EGP " + sales);
        }
    ...
    *****************************************************************/
    private class OrderDetailPanel extends JPanel implements ActionListener, ListSelectionListener
    {
        ...
        public OrderDetailPanel()
        {
            ...
            btnFood  = new JButton("Main");
            btnFood.addActionListener(this);
            gbc.gridx = 1;
            gbc.gridy = 2;
            gbLayout.setConstraints(btnFood, gbc);
            menuListPanel.add(btnFood);
